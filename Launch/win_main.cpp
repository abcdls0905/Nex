...
#include <windows.h>
#include "../RunTime/public/macros.h"
#include "../RunTime/public/i_core.h"
#include "../RunTime/public/core_config.h"
#include "../RunTime/public/fast_str.h"
#include "../RunTime/public/var_list.h"
#include "../RunTime/public/inlines.h"
	...
	int iCmdShow)
{
  ...
  freopen("CONIN$","r+t",stdin);
	...
	if (true)
	{
		...
		wndclass.lpszClassName = TEXT("nex");
		...
		HWND hwnd = CreateWindow(TEXT("nex"), TEXT("nex"), WS_OVERLAPPEDWINDOW,
